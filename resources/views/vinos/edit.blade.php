...
<div class="col-12">
    <form action="{{route("vinos.update", ["bodega" => $bodega, "vino" => $vino])}}" method="post" class="row">
        ...
        <div class="col-12">
            ...
            <input type="text" name="nombre" id="nombre" class="form-control" value="{{$vino->nombre}}">
        </div>
        <div class="col-12">
            <label for="descripcion" class="form-label">Descripcion</label>
            <textarea name="descripcion" id="descripcion" class="form-control">{{$vino->descripcion}}"</textarea>
        </div>
        <div class="col-12">
            <label for="anio" class="form-label">Año</label>
            <input type="number" name="anio" id="anio" class="form-control" value="{{$vino->anio}}">
        </div>
        <div class="col-12">
            <label for="alcohol" class="form-label">Alcohol</label>
            <input type="number" name="alcohol" id="alcohol" class="form-control" value="{{$vino->alcohol}}">
        </div>
        <div class="col-12">
