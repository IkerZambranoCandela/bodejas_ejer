        ...
        <form action="{{route("bodegas.update", $bodega)}}" method="post" class="col-12">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <input type="text" name="direccion" id="direccion" class="form-control"  value="{{$bodega->direccion}}">
                </div>
                <div class="col-12">
                    <label for="email" class=" form-label ">Email</label>
                    <input type="email" name="email" id="email" class="form-control"  value="{{$bodega->email}}">
                </div>
                <div class="col-12">
                    <label for="telefono" class=" form-label ">Telefono</label>
                    <input type="tel" name="telefono" id="telefono" class="form-control"  value="{{$bodega->telefono}}">
                </div>
                <div class="col-12">
                    <label for="persona_contacto" class=" form-label ">Persona de contacto</label>
                    <input type="text" name="persona_contacto" id="persona_contacto" class="form-control"  value="{{$bodega->persona_contacto}}">
                </div>
                <div class="col-12">
                    <label for="anio_fundacion" class=" form-label ">Año fundacion</label>
                    <input type="number" name="anio_fundacion" id="anio_fundacion" class="form-control"  value="{{$bodega->anio_fundacion}}">
                </div>
                <div class="col-12">
                    <label for="descripcion" class=" form-label ">Descripcion</label>
                    <textarea type="text" name="descripcion" id="descripcion" class="form-control" >{{$bodega->descripcion}}</textarea>
                </div>
                <div class="col-12">
                    <h3>Dispone de hotel?</h3>
                    @if ($bodega->hotel == "s")
                        <div class="form-check">
                            <input type="radio" name="hotel" id="si_hotel" class=" form-check-input" value="s" checked >
                    ...
                    @else
                        ...
                        <div class="form-check">
                            <input type="radio" name="hotel" id="no_hotel" class=" form-check-input" value="n" checked >
                            <label for="no_hotel" class="form-check-label">No</label><br>
                        </div>
                    @endif
                </div>
                <div class="col-12">
                    ...
                    @if ($bodega->restaurante == "s")
                        <div class="form-check">
                            <input type="radio" name="restaurante" id="si_restaurante" class=" form-check-input" value="s" checked >
                    ...
                    @else
                        ...
                        <div class="form-check">
                            <input type="radio" name="restaurante" id="no_restaurante" class=" form-check-input" value="n" checked >
                            <label for="no_restaurante" class="form-check-label">No</label><br>
                        </div>
                    @endif
...
<div class="col col-md-6">
    <div class="row">
        <div class="col-12">
            ...
            <a href="{{route("vinos.create", $bodega)}}">+ Añadir vino</a>
        </div>
        <div class="col-12">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="d-flex align-items-center gap-2">
                            <a href="{{ route("vinos.show", ['bodega' => $bodega, 'vino' => $vino]) }}" class="btn btn-primary">Ver</a>
